      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex space-x-2">
          <button
            ...
            className={`px-4 py-2 text-sm rounded-lg font-medium transition-colors ${analyticsTimeRange === '30d'
          ...
          <button
            ...
            className={`px-4 py-2 text-sm rounded-lg font-medium transition-colors ${analyticsTimeRange === '90d'
                ? 'bg-blue-100 text-blue-700'
                : 'text-gray-600 hover:bg-gray-100'
              }`}
          >
          ...
          <button
            ...
            className={`px-4 py-2 text-sm rounded-lg font-medium transition-colors ${analyticsTimeRange === '1y'
                ? 'bg-blue-100 text-blue-700'
                : 'text-gray-600 hover:bg-gray-100'
              }`}
          >
      ...
      <div className="w-64 bg-white shadow-sm border-r border-gray-200 flex flex-col fixed h-full z-10">
        ...
        <nav className="flex-1 p-4 space-y-2">
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentPage === 'dashboard' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentPage === 'residents' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentPage === 'safety' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentPage === 'communications' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentPage === 'social' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentPage === 'events' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentPage === 'analytics' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentPage === 'amenities' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentPage === 'settings' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
              }`}
          >
          ...
          <button
            ...
            className={`flex items-center space-x-3 px-3 py-2 rounded-lg transition-colors w-full text-left ${currentPage === 'resident-home' ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-50'
              }`}
          >
            <Users className="w-5 h-5" />
        ...
        <div className="flex-1 p-6 space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${activityFilter === 'all' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                      >
                        All
                      </button>
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${activityFilter === 'safety' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                      >
                        Safety
                      </button>
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${activityFilter === 'maintenance' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                      >
                        Maintenance
                      </button>
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${activityFilter === 'community' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                      >
                        Community
                      </button>
                  ...
                  <div className="flex flex-col sm:flex-row gap-3 flex-1">
                    ...
                    <div className="flex flex-wrap gap-2">
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${eventsFilter === 'all' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${eventsFilter === 'upcoming' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                      >
                      ...
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${eventsFilter === 'social' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                      >
                        Social
                      </button>
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${eventsFilter === 'wellness' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                      >
                        Wellness
                      </button>
                      <button
                        ...
                        className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${eventsFilter === 'safety' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                          }`}
                      >
                        Safety
                      </button>
          ...
          {currentPage === 'analytics' && (
            <>
              ...
              <div className="bg-white rounded-lg shadow-sm border border-gray-200 p-1 mb-6">
                <div className="flex space-x-1">
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center space-x-2 px-4 py-3 rounded-lg font-medium text-sm transition-colors ${analyticsTab === 'executive'
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center space-x-2 px-4 py-3 rounded-lg font-medium text-sm transition-colors ${analyticsTab === 'residents'
                        ? 'bg-blue-100 text-blue-700 shadow-sm'
                        : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center space-x-2 px-4 py-3 rounded-lg font-medium text-sm transition-colors ${analyticsTab === 'community'
                        ? 'bg-blue-100 text-blue-700 shadow-sm'
                        : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center space-x-2 px-4 py-3 rounded-lg font-medium text-sm transition-colors ${analyticsTab === 'communication'
                        ? 'bg-blue-100 text-blue-700 shadow-sm'
                        : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                      }`}
                  >
                  ...
                  <button
                    ...
                    className={`flex-1 flex items-center justify-center space-x-2 px-4 py-3 rounded-lg font-medium text-sm transition-colors ${analyticsTab === 'ai'
                        ? 'bg-blue-100 text-blue-700 shadow-sm'
                        : 'text-gray-600 hover:text-gray-900 hover:bg-gray-50'
                      }`}
                  >
                          ...
                          <div className="mt-3">
                            <div className="flex items-end space-x-1 h-8">
                              {[68, 71, 69, 74, 76, 78, 79, 81, 82, 84.2].map((value, index) => (
                                <div
                                  key={index}
                                  className={`rounded-sm flex-1 transition-all duration-300 hover:bg-purple-400 ${index >= 7 ? 'bg-green-400' : 'bg-purple-200'
                                    }`}
                                  style={{ height: `${(value / 100) * 32}px` }}
                  ...
                  <div className="flex-1 p-4 overflow-y-auto space-y-3">
                    {noraMessages.map((message) => (
                      <div key={message.id} className={`flex ${message.type === 'nora' ? 'justify-start' : 'justify-end'}`}>
                        <div className={`max-w-xs p-3 rounded-lg ${message.type === 'nora'
              ...
              {/* Beautiful Pulsating Nora Quick Actions Button */}
              {!showNoraChat && (
                <div className="fixed bottom-4 right-4 z-40">
                  ...
                  <div className="absolute inset-0 rounded-full">
                    ...
                    <div className="absolute inset-0 rounded-full bg-gradient-to-r from-purple-400 to-pink-500 opacity-25 animate-ping" style={{ animationDelay: '0.5s' }}></div>
                    <div className="absolute inset-0 rounded-full bg-gradient-to-r from-blue-500 to-purple-600 opacity-15 animate-ping" style={{ animationDelay: '1s' }}></div>
                  </div>

                  {/* Sparkle Effects */}
                  <div className="absolute -top-2 -right-2 w-2 h-2 bg-yellow-300 rounded-full animate-pulse opacity-80"></div>
                  <div className="absolute -top-1 -left-3 w-1 h-1 bg-blue-300 rounded-full animate-pulse" style={{ animationDelay: '0.3s' }}></div>
                  <div className="absolute -bottom-2 -left-1 w-1.5 h-1.5 bg-purple-300 rounded-full animate-pulse" style={{ animationDelay: '0.8s' }}></div>

                  {/* Main Button */}
                  <button
                    onClick={() => setShowNoraChat(true)}
                    className="relative w-14 h-14 bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600 text-white rounded-full shadow-2xl hover:shadow-purple-500/50 transition-all duration-300 transform hover:scale-110 hover:rotate-3 flex items-center justify-center group overflow-hidden"
                  >
                    {/* Button Shine Effect */}
                    <div className="absolute inset-0 bg-gradient-to-tr from-white/20 to-transparent rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>

                    {/* Nora Icon */}
                    <NoraIcon size={28} className="text-white relative z-10 drop-shadow-sm group-hover:scale-110 transition-transform duration-300" />

                    {/* Enhanced Notification Badge */}
                    {noraNotifications.filter(n => !n.seen).length > 0 && (
                      <div className="absolute -top-1 -right-1 w-6 h-6 bg-gradient-to-r from-red-500 to-pink-500 rounded-full flex items-center justify-center shadow-lg animate-bounce">
                        <span className="text-white text-xs font-bold drop-shadow-sm">
                          {noraNotifications.filter(n => !n.seen).length}
                        </span>
                    ...
                    {/* Floating Tooltip */}
                    <div className="absolute bottom-full mb-3 left-1/2 transform -translate-x-1/2 bg-gray-900 text-white px-3 py-2 rounded-lg text-xs whitespace-nowrap opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none">
                      <div className="font-semibold">Chat with Nora</div>
                      <div className="text-gray-300 text-xs">Your AI Community Assistant</div>
                      {/* Tooltip Arrow */}
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                      <div className="flex flex-wrap gap-2">
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${amenitiesFilter === 'all' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${amenitiesFilter === 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${amenitiesFilter === 'approved' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${amenitiesFilter === 'declined' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                          ...
                          {amenityBookings
                            ...
                            .map((booking) => (
                              <div key={booking.id} className="flex items-start space-x-3">
                                ...
                                <span className={`w-2 h-2 rounded-full ${booking.status === 'pending' ? 'bg-yellow-400' :
                    ...
                    <div className="p-6 border-b border-gray-200">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <span className={`inline-flex items-center px-3 py-1 rounded-full text-sm font-medium ${selectedBooking.status === 'pending' ? 'bg-yellow-100 text-yellow-800' :
                    ...
                    <div className="border-b border-gray-200">
                      <nav className="-mb-px flex space-x-8">
                        <button
                          ...
                          className={`py-2 px-1 border-b-2 font-medium text-sm transition-colors ${settingsTab === 'property'
                        ...
                        <button
                          ...
                          className={`py-2 px-1 border-b-2 font-medium text-sm transition-colors ${settingsTab === 'units'
                              ? 'border-blue-500 text-blue-600'
                              : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`py-2 px-1 border-b-2 font-medium text-sm transition-colors ${settingsTab === 'amenities'
                              ? 'border-blue-500 text-blue-600'
                              : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`py-2 px-1 border-b-2 font-medium text-sm transition-colors ${settingsTab === 'nora'
                              ? 'border-blue-500 text-blue-600'
                              : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300'
                            }`}
                        >
                          <NoraIcon
                            size={16}
                            className={`inline mr-1 ${settingsTab === 'nora' ? 'text-blue-600' : 'text-gray-500'
                              }`}
                          />
                          Nora AI
                        </button>
                          ...
                          {amenities.map((amenity, index) => (
                            <div key={index} className="flex items-center justify-between p-4 border border-gray-200 rounded-lg">
                              ...
                              <button
                                ...
                                className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 ${amenity.enabled ? 'bg-blue-600' : 'bg-gray-200'
                                  }`}
                              >
                                <span
                                  className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${amenity.enabled ? 'translate-x-5' : 'translate-x-0'
                                    }`}
                                />
                              </button>
                            </div>
                                ...
                                {[
                                  ...
                                  <div key={action.key} className="flex items-center justify-between">
                                    ...
                                    <button
                                      ...
                                      className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${noraSettings.autoActions[action.key] ? 'bg-purple-600' : 'bg-gray-200'
                                        }`}
                                    >
                                      <span
                                        className={`pointer-events-none inline-block h-5 w-5 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${noraSettings.autoActions[action.key] ? 'translate-x-5' : 'translate-x-0'
                                          }`}
                                      />
                                    </button>
                                  </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-purple-200">
                          <div className="flex items-center justify-between">
                            ...
                            <button
                              ...
                              className={`relative inline-flex h-8 w-14 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 ${noraSettings.learningEnabled ? 'bg-purple-600' : 'bg-gray-200'
                                }`}
                            >
                              <span
                                className={`pointer-events-none inline-block h-7 w-7 transform rounded-full bg-white shadow ring-0 transition duration-200 ease-in-out ${noraSettings.learningEnabled ? 'translate-x-6' : 'translate-x-0'
                                  }`}
                              />
                            </button>
                          </div>
                    ...
                    <div className="flex space-x-2">
                      {['All Posts', 'Events', 'Recommendations', 'Safety', 'Marketplace'].map((category) => (
                        <button
                          ...
                          className={`flex-1 px-4 py-2 rounded-lg font-medium transition-colors ${activeCategory === category
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                      <div className="flex flex-wrap gap-3">
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${safetyFilter === 'all' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${safetyFilter === 'open' ? 'bg-orange-100 text-orange-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${safetyFilter === 'high-priority' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                        ...
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${safetyFilter === 'theft' ? 'bg-red-100 text-red-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                          Theft
                        </button>
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${safetyFilter === 'security' ? 'bg-orange-100 text-orange-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                          Security
                        </button>
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${safetyFilter === 'maintenance' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                          Maintenance
                        </button>
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${safetyFilter === 'resolved' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
                      <div className="flex flex-col sm:flex-row gap-3 flex-1">
                        ...
                        <div className="flex gap-2">
                          <button
                            onClick={() => setResidentFilter('all')}
                            className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${residentFilter === 'all' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                              }`}
                          >
                          ...
                          <button
                            onClick={() => setResidentFilter('active')}
                            className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${residentFilter === 'active' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                              }`}
                          >
                          ...
                          <button
                            onClick={() => setResidentFilter('pending')}
                            className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${residentFilter === 'pending' ? 'bg-yellow-100 text-yellow-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                              }`}
                          >
                    ...
                    <div className="p-4 border-b border-gray-200">
                      <div className="flex flex-wrap gap-2">
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${commFilter === 'center' ? 'bg-blue-100 text-blue-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                          Message Center
                        </button>
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${commFilter === 'announcements' ? 'bg-green-100 text-green-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                          Announcements
                        </button>
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${commFilter === 'templates' ? 'bg-purple-100 text-purple-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                          Templates
                        </button>
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${commFilter === 'direct' ? 'bg-orange-100 text-orange-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                          Direct Messages
                        </button>
                        <button
                          ...
                          className={`px-4 py-2 rounded-lg font-medium text-sm transition-colors ${commFilter === 'reports' ? 'bg-pink-100 text-pink-800' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'
                            }`}
                        >
                          Delivery Reports
                        </button>
                  ...
                  <div className="flex space-x-3">
                    {['Low', 'Normal', 'High', 'Urgent'].map((priority) => (
                      <label key={priority} className="flex items-center cursor-pointer">
                        ...
                        />
                        <span className={`ml-2 text-sm font-medium ${priority === 'Urgent' ? 'text-red-600' :
              ...
              <div className="p-6 space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <span className={`inline-block px-2 py-1 rounded-full text-xs font-medium ${selectedResident.status === 'active' ? 'bg-green-100 text-green-800' :
